...
import Udacity.controller.Controller;
import Udacity.controller.TableAction;
...
public ArrayList<HeadInvoice> getInvoices(){
    if(invoices==null){
    ...
    public void setInvoices(ArrayList<HeadInvoice> invoices) {
   ...
   public int getTotalInvNum(){
       int num=0;
       for(HeadInvoice invoice: invoices){
